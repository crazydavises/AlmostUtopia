<?php
/*
Plugin Name: WorldBank DataTracking
Plugin URI: http://testing.designdavis.com
Description: WorldBank Game
Version: 0.1
Author: Amy Davis
...
class WorldBank
{
	...
	function __construct()
	{
		...
		register_activation_hook(__FILE__,'WorldBank_install');
	}

	function WorldBank_install () 
	{
	global $wpdb;
	global $finanzasfilios_db_version;

	//$intelibus_army_table = $wpdb->prefix ."_intelibus_army"; 
	$sql = "CREATE TABLE intelibus_army_table (
		id mediumint(9) NOT NULL AUTO_INCREMENT,
		day mediumint(7),
		numTanks mediumint(7),
		numBoats mediumint(7),
		numAirplanes mediumint(7),
		numSoldiers mediumint(7),
		numBases mediumint(7), 
		UNIQUE KEY id (id) 
		)";
	...
	dbDelta($sql);
 	...
 	add_option("finanzasfilios_db_version", "1.0");
...
{
    $email_to = "registration@lifestrokes.com";
